...
_StringType1_contra = TypeVar(
    "_StringType1_contra", contravariant=True, bound=Sequence[Hashable]
)
_StringType2_contra = TypeVar(
    "_StringType2_contra", contravariant=True, bound=Sequence[Hashable]
)
...
class _Scorer(
    Protocol[
        _StringType1_contra, _StringType2_contra, _ResultType_contra, _ResultType_co
    ]
):
    def __call__(
        self,
...
try:
    ...
    def cdist(
        ...
        *,
        scorer: _Scorer[Sequence[Hashable], Sequence[Hashable], float, float] = ratio,
        processor: Callable[
            [_UnprocessedType1 | _UnprocessedType2], Sequence[Hashable]
        ],
        score_cutoff: float | None = None,
        score_hint: float | None = None,
        score_multiplier: float = 1,
