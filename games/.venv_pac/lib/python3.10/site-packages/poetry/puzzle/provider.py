...
from poetry.games.nexus_omniengine_v3.core.version.markers import union as marker_union
...
if TYPE_CHECKING:
    ...
    from poetry.games.nexus_omniengine_v3.core.packages.package import Package
