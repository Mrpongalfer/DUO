...
"""
    ...
    def _init_pyproject(
        ...
        from poetry.games.nexus_omniengine_v3.core.vcs.git import GitConfig
    ...
    def _parse_requirements(self, requirements: list[str]) -> list[dict[str, Any]]:
        from poetry.games.nexus_omniengine_v3.core.pyproject.exceptions import PyProjectError
