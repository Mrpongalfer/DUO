...
from poetry.games.nexus_omniengine_v3.core.constraints.generic import BaseConstraint
from poetry.games.nexus_omniengine_v3.core.constraints.generic import Constraint
from poetry.games.nexus_omniengine_v3.core.constraints.generic import MultiConstraint
from poetry.games.nexus_omniengine_v3.core.constraints.generic import UnionConstraint
from poetry.games.nexus_omniengine_v3.core.constraints.generic.parser import STR_CMP_CONSTRAINT
from poetry.games.nexus_omniengine_v3.core.constraints.version import VersionConstraint
from poetry.games.nexus_omniengine_v3.core.constraints.version import VersionRange
...
from poetry.games.nexus_omniengine_v3.core.version.grammars import GRAMMAR_PEP_508_MARKERS
from poetry.games.nexus_omniengine_v3.core.version.parser import Parser
...
class SingleMarkerLike(BaseMarker, ABC, Generic[SingleMarkerConstraint]):
    def __init__(self, name: str, constraint: SingleMarkerConstraint) -> None:
        ...
        from poetry.games.nexus_omniengine_v3.core.constraints.generic import parse_extra_constraint
        from poetry.games.nexus_omniengine_v3.core.constraints.version import parse_marker_version_constraint
...
class SingleMarker(SingleMarkerLike[Union[BaseConstraint, VersionConstraint]]):
    ...
    def reduce_by_python_constraint(
        ...
        if self.name in PYTHON_VERSION_MARKERS:
            ...
            from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import (
    ...
    def invert(self) -> BaseMarker:
        if self._operator in ("===", "=="):
            ...
            from poetry.games.nexus_omniengine_v3.core.constraints.version import VersionRangeConstraint
...
class MultiMarker(BaseMarker):
    ...
    def union_simplify(self, other: BaseMarker) -> BaseMarker | None:
        ...
        """
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import get_python_constraint_from_marker
