...
if TYPE_CHECKING:
    from poetry.games.nexus_omniengine_v3.core.masonry.utils.module import Module
...
class Builder:
    ...
    def __init__(
        ...
        from poetry.games.nexus_omniengine_v3.core.masonry.metadata import Metadata
    ...
    def find_excluded_files(self, fmt: str | None = None) -> set[str]:
        if self._excluded_files is None:
            from poetry.games.nexus_omniengine_v3.core.vcs import get_vcs
