...
if TYPE_CHECKING:
    from poetry.games.nexus_omniengine_v3.core.constraints.version.version import Version
    from poetry.games.nexus_omniengine_v3.core.constraints.version.version_constraint import VersionConstraint
...
def _parse_constraint(
    ...
    if constraints == "*":
        from poetry.games.nexus_omniengine_v3.core.constraints.version.version_range import VersionRange
    ...
    if len(or_groups) == 1:
        ...
        from poetry.games.nexus_omniengine_v3.core.constraints.version.version_union import VersionUnion
...
def parse_single_constraint(
    ...
    from poetry.games.nexus_omniengine_v3.core.constraints.version.patterns import BASIC_CONSTRAINT
    from poetry.games.nexus_omniengine_v3.core.constraints.version.patterns import BASIC_RELEASE_CONSTRAINT
    from poetry.games.nexus_omniengine_v3.core.constraints.version.patterns import CARET_CONSTRAINT
    from poetry.games.nexus_omniengine_v3.core.constraints.version.patterns import TILDE_CONSTRAINT
    from poetry.games.nexus_omniengine_v3.core.constraints.version.patterns import TILDE_PEP440_CONSTRAINT
    from poetry.games.nexus_omniengine_v3.core.constraints.version.patterns import X_CONSTRAINT
    from poetry.games.nexus_omniengine_v3.core.constraints.version.version import Version
    from poetry.games.nexus_omniengine_v3.core.constraints.version.version_range import VersionRange
    from poetry.games.nexus_omniengine_v3.core.constraints.version.version_union import VersionUnion
