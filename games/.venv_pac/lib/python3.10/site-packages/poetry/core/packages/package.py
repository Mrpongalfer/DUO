...
from poetry.games.nexus_omniengine_v3.core.constraints.version.exceptions import ParseConstraintError
...
from poetry.games.nexus_omniengine_v3.core.utils.patterns import AUTHOR_REGEX
from poetry.games.nexus_omniengine_v3.core.version.exceptions import InvalidVersionError
...
if TYPE_CHECKING:
    ...
    from poetry.games.nexus_omniengine_v3.core.packages.dependency import Dependency
    from poetry.games.nexus_omniengine_v3.core.packages.dependency_group import DependencyGroup
    from poetry.games.nexus_omniengine_v3.core.spdx.license import License
...
class Package(PackageSpecification):
    ...
    def license(self, value: str | License | None) -> None:
        from poetry.games.nexus_omniengine_v3.core.spdx.helpers import license_by_id
        from poetry.games.nexus_omniengine_v3.core.spdx.license import License
    ...
    def satisfies(
        ...
        if not (
            ignore_source_type or self.source_satisfies(dependency)
        ):  # noqa: SIM103
            return False
