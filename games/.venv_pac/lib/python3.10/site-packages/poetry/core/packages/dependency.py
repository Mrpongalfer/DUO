...
from poetry.games.nexus_omniengine_v3.core.constraints.generic import parse_constraint as parse_generic_constraint
from poetry.games.nexus_omniengine_v3.core.constraints.version import parse_constraint
from poetry.games.nexus_omniengine_v3.core.packages.dependency_group import MAIN_GROUP
from poetry.games.nexus_omniengine_v3.core.packages.specification import PackageSpecification
from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import contains_group_without_marker
from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import create_nested_marker
from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import normalize_python_version_markers
from poetry.games.nexus_omniengine_v3.core.version.markers import parse_marker
...
if TYPE_CHECKING:
    ...
    from poetry.games.nexus_omniengine_v3.core.constraints.version import VersionConstraint
    from poetry.games.nexus_omniengine_v3.core.packages.directory_dependency import DirectoryDependency
    from poetry.games.nexus_omniengine_v3.core.packages.file_dependency import FileDependency
    from poetry.games.nexus_omniengine_v3.core.version.markers import BaseMarker
...
class Dependency(PackageSpecification):
    def __init__(
        ...
        from poetry.games.nexus_omniengine_v3.core.version.markers import AnyMarker
    ...
    def marker(self, marker: str | BaseMarker) -> None:
        from poetry.games.nexus_omniengine_v3.core.constraints.version import parse_constraint
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import convert_markers
        from poetry.games.nexus_omniengine_v3.core.version.markers import BaseMarker
        from poetry.games.nexus_omniengine_v3.core.version.markers import parse_marker
    ...
    def base_pep_508_name(self) -> str:
        from poetry.games.nexus_omniengine_v3.core.constraints.version import Version
        from poetry.games.nexus_omniengine_v3.core.constraints.version import VersionUnion
    ...
    def create_from_pep_508(
        ...
        """
        from poetry.games.nexus_omniengine_v3.core.packages.url_dependency import URLDependency
        from poetry.games.nexus_omniengine_v3.core.packages.utils.link import Link
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import cached_is_dir
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import is_archive_file
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import is_python_project
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import is_url
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import path_to_url
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import strip_extras
        from poetry.games.nexus_omniengine_v3.core.packages.utils.utils import url_to_path
        from poetry.games.nexus_omniengine_v3.core.packages.vcs_dependency import VCSDependency
        from poetry.games.nexus_omniengine_v3.core.utils.patterns import wheel_file_re
        from poetry.games.nexus_omniengine_v3.core.vcs.git import ParsedUrl
        from poetry.games.nexus_omniengine_v3.core.version.requirements import parse_requirement
