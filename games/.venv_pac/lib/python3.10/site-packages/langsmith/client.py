...
class Client:
    ...
    def create_commit(
        ...
        *,
        ...
        try:
            from langchain_games.nexus_omniengine_v3.core.load.dump import dumps
        except ImportError:
            raise ImportError(
    ...
    def pull_prompt(
        ...
        """
        try:
            from langchain_games.nexus_omniengine_v3.core.language_models.base import BaseLanguageModel
            from langchain_games.nexus_omniengine_v3.core.load.load import loads
            ...
            from langchain_games.nexus_omniengine_v3.core.prompts.structured import StructuredPrompt
            from langchain_games.nexus_omniengine_v3.core.runnables.base import RunnableBinding, RunnableSequence
        except ImportError:
            raise ImportError(
        ...
        try:
            from langchain_games.nexus_omniengine_v3.core._api import suppress_langchain_beta_warning
        except ImportError:
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            .. code-block:: python
                ...
                from langchain_games.nexus_omniengine_v3.core.runnables import chain as as_runnable
