...
from langchain_games.nexus_omniengine_v3.core.messages.ai import UsageMetadata, add_usage
from langchain_games.nexus_omniengine_v3.core.outputs import ChatGeneration, LLMResult
...
class UsageMetadataCallbackHandler(BaseCallbackHandler):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.callbacks import UsageMetadataCallbackHandler
...
def get_usage_metadata_callback(
    ...
    Example:
        .. code-block:: python
            ...
            from langchain.chat_models import init_chat_model
            from langchain_games.nexus_omniengine_v3.core.callbacks import get_usage_metadata_callback
    ...
    .. versionadded:: 0.3.49
    """
    from langchain_games.nexus_omniengine_v3.core.tracers.context import register_configure_hook
