...
from langchain_games.nexus_omniengine_v3.core.callbacks.base import (
    BaseCallbackHandler,
    BaseCallbackManager,
    Callbacks,
    ChainManagerMixin,
...
from langchain_games.nexus_omniengine_v3.core.callbacks.stdout import StdOutCallbackHandler
from langchain_games.nexus_omniengine_v3.core.messages import BaseMessage, get_buffer_string
from langchain_games.nexus_omniengine_v3.core.tracers.schemas import Run
from langchain_games.nexus_omniengine_v3.core.utils.env import env_var_is_set
...
if TYPE_CHECKING:
    ...
    from langchain_games.nexus_omniengine_v3.core.agents import AgentAction, AgentFinish
    from langchain_games.nexus_omniengine_v3.core.documents import Document
    from langchain_games.nexus_omniengine_v3.core.outputs import ChatGenerationChunk, GenerationChunk, LLMResult
    from langchain_games.nexus_omniengine_v3.core.runnables.config import RunnableConfig

logger = logging.getLogger(__name__)


def _get_debug() -> bool:
    from langchain_games.nexus_omniengine_v3.core.globals import get_debug
...
def trace_as_chain_group(
    ...
    *,
    ...
    """  # noqa: E501
    from langchain_games.nexus_omniengine_v3.core.tracers.context import _get_trace_callbacks
    ...
    def merge(
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from langchain_games.nexus_omniengine_v3.core.callbacks.manager import CallbackManager, trace_as_chain_group
                from langchain_games.nexus_omniengine_v3.core.callbacks.stdout import StdOutCallbackHandler
    ...
    def merge(
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from langchain_games.nexus_omniengine_v3.core.callbacks.manager import CallbackManager, atrace_as_chain_group
                from langchain_games.nexus_omniengine_v3.core.callbacks.stdout import StdOutCallbackHandler
...
def _configure(
    ...
    *,
    ...
    """
    from langchain_games.nexus_omniengine_v3.core.tracers.context import (
        _configure_hooks,
        _get_tracer_project,
    ...
    if verbose or debug or tracing_v2_enabled_:
        from langchain_games.nexus_omniengine_v3.core.tracers.langchain import LangChainTracer
        from langchain_games.nexus_omniengine_v3.core.tracers.stdout import ConsoleCallbackHandler
...
async def adispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnable import RunnableLambda
...
def dispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.callbacks import BaseCallbackHandler
            from langchain_games.nexus_omniengine_v3.core.callbacks import dispatch_custom_event
            from langchain_games.nexus_omniengine_v3.core.runnable import RunnableLambda
