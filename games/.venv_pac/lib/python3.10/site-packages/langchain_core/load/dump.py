...
from langchain_games.nexus_omniengine_v3.core.load.serializable import Serializable, to_json_not_implemented
...
def _dump_pydantic_models(obj: Any) -> Any:
    ...
    from langchain_games.nexus_omniengine_v3.core.outputs import ChatGeneration
