...
from langchain_games.nexus_omniengine_v3.core._api import beta, deprecated
from langchain_games.nexus_omniengine_v3.core.messages import AIMessage, BaseMessage, HumanMessage, ToolMessage
from langchain_games.nexus_omniengine_v3.core.utils.json_schema import dereference_refs
...
def _convert_python_function_to_openai_function(
    ...
    """
    from langchain_games.nexus_omniengine_v3.core.tools.base import create_schema_from_function
...
def _format_tool_to_openai_function(tool: BaseTool) -> FunctionDescription:
    ...
    Returns:
        The function description.
    """
    from langchain_games.nexus_omniengine_v3.core.tools import simple
