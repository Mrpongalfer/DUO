...
from langchain_games.nexus_omniengine_v3.core.exceptions import ErrorCode, create_message
from langchain_games.nexus_omniengine_v3.core.messages import convert_to_openai_data_block, is_data_content_block
from langchain_games.nexus_omniengine_v3.core.messages.ai import AIMessage, AIMessageChunk
from langchain_games.nexus_omniengine_v3.core.messages.base import BaseMessage, BaseMessageChunk
from langchain_games.nexus_omniengine_v3.core.messages.chat import ChatMessage, ChatMessageChunk
from langchain_games.nexus_omniengine_v3.core.messages.function import FunctionMessage, FunctionMessageChunk
from langchain_games.nexus_omniengine_v3.core.messages.human import HumanMessage, HumanMessageChunk
from langchain_games.nexus_omniengine_v3.core.messages.modifier import RemoveMessage
from langchain_games.nexus_omniengine_v3.core.messages.system import SystemMessage, SystemMessageChunk
from langchain_games.nexus_omniengine_v3.core.messages.tool import ToolCall, ToolMessage, ToolMessageChunk

if TYPE_CHECKING:
    from langchain_text_splitters import TextSplitter

    from langchain_games.nexus_omniengine_v3.core.language_models import BaseLanguageModel
    from langchain_games.nexus_omniengine_v3.core.prompt_values import PromptValue
    from langchain_games.nexus_omniengine_v3.core.runnables.base import Runnable
...
def _runnable_support(func: Callable) -> Callable:
    ...
    def wrapped(
        ...
        **kwargs: Any,
        ...
        from langchain_games.nexus_omniengine_v3.core.runnables.base import RunnableLambda
    ...
    *,
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.messages import filter_messages, AIMessage, HumanMessage, SystemMessage
