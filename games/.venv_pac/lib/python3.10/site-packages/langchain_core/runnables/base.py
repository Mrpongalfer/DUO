...
from langchain_games.nexus_omniengine_v3.core._api import beta_decorator
from langchain_games.nexus_omniengine_v3.core.load.serializable import (
    Serializable,
    SerializedConstructor,
    SerializedNotImplemented,
)
from langchain_games.nexus_omniengine_v3.core.runnables.config import (
    RunnableConfig,
...
from langchain_games.nexus_omniengine_v3.core.runnables.graph import Graph
from langchain_games.nexus_omniengine_v3.core.runnables.utils import (
    AddableDict,
...
from langchain_games.nexus_omniengine_v3.core.utils.aiter import aclosing, atee, py_anext
from langchain_games.nexus_omniengine_v3.core.utils.iter import safetee
from langchain_games.nexus_omniengine_v3.core.utils.pydantic import create_model_v2

if TYPE_CHECKING:
    from langchain_games.nexus_omniengine_v3.core.callbacks.manager import (
        AsyncCallbackManagerForChainRun,
        CallbackManagerForChainRun,
    )
    from langchain_games.nexus_omniengine_v3.core.prompts.base import BasePromptTemplate
    from langchain_games.nexus_omniengine_v3.core.runnables.fallbacks import (
        RunnableWithFallbacks as RunnableWithFallbacksT,
    )
    from langchain_games.nexus_omniengine_v3.core.runnables.retry import ExponentialJitterParams
    from langchain_games.nexus_omniengine_v3.core.runnables.schema import StreamEvent
    from langchain_games.nexus_omniengine_v3.core.tools import BaseTool
    from langchain_games.nexus_omniengine_v3.core.tracers.log_stream import (
        RunLog,
        RunLogPatch,
    )
    from langchain_games.nexus_omniengine_v3.core.tracers.root_listeners import AsyncListener
    from langchain_games.nexus_omniengine_v3.core.tracers.schemas import Run
...
class Runnable(Generic[Input, Output], ABC):
    ...
    **RunnableParallel** invokes runnables concurrently, providing the same input
    ...
    .. code-block:: python
        ...
        from langchain_games.nexus_omniengine_v3.core.runnables import RunnableLambda
    ...
    You can set the global debug flag to True to enable debug output for all chains:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.globals import set_debug
            set_debug(True)
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.tracers import ConsoleCallbackHandler
    ...
    def pick(self, keys: Union[str, list[str]]) -> RunnableSerializable[Any, Any]:
        ...
        Pick single key:
            .. code-block:: python
                ...
                from langchain_games.nexus_omniengine_v3.core.runnables import RunnableLambda, RunnableMap
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.runnables.passthrough import RunnablePick
    ...
    def assign(
        ...
        **kwargs: Union[
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.output_parsers import StrOutputParser
            from langchain_games.nexus_omniengine_v3.core.prompts import SystemMessagePromptTemplate
            from langchain_games.nexus_omniengine_v3.core.runnables import Runnable
            from operator import itemgetter
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.runnables.passthrough import RunnableAssign
    ...
    async def astream_events(
        ...
        **ATTENTION** This reference table is for the V2 version of the schema.
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables import RunnableLambda, RunnableConfig
            import asyncio
        ...
        """  # noqa: E501
        from langchain_games.nexus_omniengine_v3.core.tracers.event_stream import (
    ...
    def with_listeners(
        ...
        *,
        ...
        .. code-block:: python
            ...
            chain.invoke(2)
        """
        from langchain_games.nexus_omniengine_v3.core.tracers.root_listeners import RootListenersTracer
    ...
    def with_alisteners(
        ...
        *,
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables import RunnableLambda, Runnable
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.tracers.root_listeners import AsyncRootListenersTracer
    ...
    def with_retry(
        ...
        *,
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.runnables.retry import RunnableRetry
        ...
        *,
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from langchain_games.nexus_omniengine_v3.core.runnables import RunnableGenerator
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.runnables.fallbacks import RunnableWithFallbacks
    ...
    def _transform_stream_with_config(
        ...
        **kwargs: Optional[Any],
        ...
        from langchain_games.nexus_omniengine_v3.core.tracers._streaming import _StreamingCallbackHandler
    ...
    def as_tool(
        ...
        *,
        ...
        from langchain_games.nexus_omniengine_v3.core.tools import convert_runnable_to_tool
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    ...
    def configurable_fields(
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables import ConfigurableField
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.runnables.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Union[Runnable[Input, Output], Callable[[], Runnable[Input, Output]]],
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables.utils import ConfigurableField
            from langchain_openai import ChatOpenAI
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.runnables.configurable import (
...
def _seq_input_schema(
    ...
    from langchain_games.nexus_omniengine_v3.core.runnables.passthrough import RunnableAssign, RunnablePick
    ...
    **RunnableSequence** is the most important composition operator in LangChain
    ...
    Here's an example that uses streams JSON output generated by an LLM:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.output_parsers.json import SimpleJsonOutputParser
            from langchain_openai import ChatOpenAI
    ...
    def config_specs(self) -> list[ConfigurableFieldSpec]:
        ...
        """
        from langchain_games.nexus_omniengine_v3.core.beta.runnables.context import (
    ...
    def invoke(
        ...
        from langchain_games.nexus_omniengine_v3.core.beta.runnables.context import config_with_context
    ...
    async def ainvoke(
        ...
        **kwargs: Optional[Any],
        ...
        from langchain_games.nexus_omniengine_v3.core.beta.runnables.context import aconfig_with_context
    ...
    def batch(
        ...
        **kwargs: Optional[Any],
        ...
        from langchain_games.nexus_omniengine_v3.core.beta.runnables.context import config_with_context
        from langchain_games.nexus_omniengine_v3.core.callbacks.manager import CallbackManager
    ...
    async def abatch(
        ...
        **kwargs: Optional[Any],
        ...
        from langchain_games.nexus_omniengine_v3.core.beta.runnables.context import aconfig_with_context
        from langchain_games.nexus_omniengine_v3.core.callbacks.manager import AsyncCallbackManager
...
class RunnableParallel(RunnableSerializable[Input, dict[str, Any]]):
    ...
    we simultaneously stream output from two different Runnables:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.prompts import ChatPromptTemplate
            from langchain_games.nexus_omniengine_v3.core.runnables import RunnableParallel
            from langchain_openai import ChatOpenAI
...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    context. Below we show an example:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.prompts import ChatPromptTemplate
            from langchain_games.nexus_omniengine_v3.core.runnables import RunnableGenerator, RunnableLambda
            from langchain_openai import ChatOpenAI
            from langchain_games.nexus_omniengine_v3.core.output_parsers import StrOutputParser
...
class RunnableEach(RunnableEachBase[Input, Output]):
    ...
    with a Runnable:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables.base import RunnableEach
            from langchain_openai import ChatOpenAI
            from langchain_games.nexus_omniengine_v3.core.prompts import ChatPromptTemplate
            from langchain_games.nexus_omniengine_v3.core.output_parsers import StrOutputParser
...
class RunnableBinding(RunnableBindingBase[Input, Output]):
    ...
    `bind`: Bind kwargs to pass to the underlying Runnable when running it.
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables import RunnableBinding
...
def chain(
    ...
    .. code-block:: python
        ...
        from langchain_games.nexus_omniengine_v3.core.runnables import chain
        from langchain_games.nexus_omniengine_v3.core.prompts import PromptTemplate
