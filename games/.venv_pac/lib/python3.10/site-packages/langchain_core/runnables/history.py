...
from langchain_games.nexus_omniengine_v3.core.chat_history import BaseChatMessageHistory
from langchain_games.nexus_omniengine_v3.core.load.load import load
from langchain_games.nexus_omniengine_v3.core.runnables.base import Runnable, RunnableBindingBase, RunnableLambda
from langchain_games.nexus_omniengine_v3.core.runnables.passthrough import RunnablePassthrough
...
if TYPE_CHECKING:
    from langchain_games.nexus_omniengine_v3.core.language_models.base import LanguageModelLike
    from langchain_games.nexus_omniengine_v3.core.messages.base import BaseMessage
...
class RunnableWithMessageHistory(RunnableBindingBase):
    ...
    .. code-block:: python
        ...
        from langchain_games.nexus_omniengine_v3.core.messages import BaseMessage, AIMessage
        from langchain_games.nexus_omniengine_v3.core.prompts import ChatPromptTemplate, MessagesPlaceholder
        from pydantic import BaseModel, Field
        from langchain_games.nexus_omniengine_v3.core.runnables import (
            RunnableLambda,
            ConfigurableFieldSpec,
            RunnablePassthrough,
        )
        from langchain_games.nexus_omniengine_v3.core.runnables.history import RunnableWithMessageHistory
    ...
    def get_input_schema(
        ...
        from langchain_games.nexus_omniengine_v3.core.messages import BaseMessage
    ...
    def _get_input_messages(
        ...
        if isinstance(input_val, str):
            from langchain_games.nexus_omniengine_v3.core.messages import HumanMessage
    ...
    def _get_output_messages(
        ...
        if isinstance(output_val, str):
            from langchain_games.nexus_omniengine_v3.core.messages import AIMessage
