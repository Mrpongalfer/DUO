...
from langchain_games.nexus_omniengine_v3.core.runnables.base import (
    Other,
    Runnable,
    RunnableParallel,
...
from langchain_games.nexus_omniengine_v3.core.utils.aiter import atee, py_anext
...
class RunnablePassthrough(RunnableSerializable[Other, Other]):
    ...
    keys to the output. In this case, you can use the `assign` method:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables import RunnablePassthrough
...
class RunnableAssign(RunnableSerializable[dict[str, Any], dict[str, Any]]):
    ...
    Examples:
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables.passthrough import (
                RunnableAssign,
                RunnableParallel,
            )
