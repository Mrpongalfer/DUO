...
if TYPE_CHECKING:
    from langchain_games.nexus_omniengine_v3.core.example_selectors.base import BaseExampleSelector
    from langchain_games.nexus_omniengine_v3.core.example_selectors.length_based import (
        LengthBasedExampleSelector,
    )
    from langchain_games.nexus_omniengine_v3.core.example_selectors.semantic_similarity import (
