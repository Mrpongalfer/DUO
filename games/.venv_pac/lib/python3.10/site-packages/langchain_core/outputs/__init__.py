...
if TYPE_CHECKING:
    from langchain_games.nexus_omniengine_v3.core.outputs.chat_generation import (
        ChatGeneration,
        ChatGenerationChunk,
    )
    from langchain_games.nexus_omniengine_v3.core.outputs.chat_result import ChatResult
    from langchain_games.nexus_omniengine_v3.core.outputs.generation import Generation, GenerationChunk
    from langchain_games.nexus_omniengine_v3.core.outputs.llm_result import LLMResult
    from langchain_games.nexus_omniengine_v3.core.outputs.run_info import RunInfo
