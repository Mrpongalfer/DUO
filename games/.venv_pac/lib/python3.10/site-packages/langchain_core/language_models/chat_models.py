...
from langchain_games.nexus_omniengine_v3.core._api import deprecated
from langchain_games.nexus_omniengine_v3.core.caches import BaseCache
from langchain_games.nexus_omniengine_v3.core.callbacks import (
...
from langchain_games.nexus_omniengine_v3.core.globals import get_llm_cache
from langchain_games.nexus_omniengine_v3.core.language_models._utils import _normalize_messages
from langchain_games.nexus_omniengine_v3.core.language_models.base import (
    BaseLanguageModel,
    LangSmithParams,
    LanguageModelInput,
)
from langchain_games.nexus_omniengine_v3.core.load import dumpd, dumps
from langchain_games.nexus_omniengine_v3.core.messages import (
    AIMessage,
    AnyMessage,
    BaseMessage,
    BaseMessageChunk,
...
from langchain_games.nexus_omniengine_v3.core.messages.ai import _LC_ID_PREFIX
from langchain_games.nexus_omniengine_v3.core.outputs import (
    ChatGeneration,
    ChatGenerationChunk,
    ChatResult,
    LLMResult,
...
from langchain_games.nexus_omniengine_v3.core.outputs.chat_generation import merge_chat_generation_chunks
from langchain_games.nexus_omniengine_v3.core.prompt_values import ChatPromptValue, PromptValue, StringPromptValue
from langchain_games.nexus_omniengine_v3.core.rate_limiters import BaseRateLimiter
from langchain_games.nexus_omniengine_v3.core.runnables import RunnableMap, RunnablePassthrough
from langchain_games.nexus_omniengine_v3.core.runnables.config import ensure_config, run_in_executor
from langchain_games.nexus_omniengine_v3.core.tracers._streaming import _StreamingCallbackHandler
from langchain_games.nexus_omniengine_v3.core.utils.function_calling import (
    convert_to_json_schema,
    convert_to_openai_tool,
)
from langchain_games.nexus_omniengine_v3.core.utils.pydantic import TypeBaseModel, is_basemodel_subclass

if TYPE_CHECKING:
    import uuid

    from langchain_games.nexus_omniengine_v3.core.output_parsers.base import OutputParserLike
    from langchain_games.nexus_omniengine_v3.core.runnables import Runnable, RunnableConfig
        ...
        **kwargs: Any,
        ...
        Example: Dict schema (include_raw=False):
            .. code-block:: python
                ...
                from pydantic import BaseModel
                from langchain_games.nexus_omniengine_v3.core.utils.function_calling import convert_to_openai_tool
        ...
        from langchain_games.nexus_omniengine_v3.core.output_parsers.openai_tools import (
