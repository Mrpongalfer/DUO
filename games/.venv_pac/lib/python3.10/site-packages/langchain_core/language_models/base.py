...
from langchain_games.nexus_omniengine_v3.core.runnables import Runnable, RunnableSerializable
from langchain_games.nexus_omniengine_v3.core.utils import get_pydantic_field_names

if TYPE_CHECKING:
    from langchain_games.nexus_omniengine_v3.core.outputs import LLMResult
...
def _get_verbosity() -> bool:
    from langchain_games.nexus_omniengine_v3.core.globals import get_verbose
...
class BaseLanguageModel(
    ...
    * If instance of BaseCache, will use the provided cache.
    ...
    def InputType(self) -> TypeAlias:
        ...
        from langchain_games.nexus_omniengine_v3.core.prompt_values import (
