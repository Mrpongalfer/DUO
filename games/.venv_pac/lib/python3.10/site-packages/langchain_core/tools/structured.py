...
from langchain_games.nexus_omniengine_v3.core.runnables import RunnableConfig, run_in_executor
...
if TYPE_CHECKING:
    from langchain_games.nexus_omniengine_v3.core.messages import ToolCall
