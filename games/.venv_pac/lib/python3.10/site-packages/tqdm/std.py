...
class tqdm(Comparable):
    ...
    def pandas(cls, **tqdm_kwargs):
        ...
        from pandas.games.nexus_omniengine_v3.core.frame import DataFrame
        from pandas.games.nexus_omniengine_v3.core.series import Series
        ...
        try:  # pandas>=1.0.0
            from pandas.games.nexus_omniengine_v3.core.window.rolling import _Rolling_and_Expanding
        except ImportError:
            try:  # pandas>=0.18.0
                from pandas.games.nexus_omniengine_v3.core.window import _Rolling_and_Expanding
            except ImportError:  # pandas>=1.2.0
                try:  # pandas>=1.2.0
                    from pandas.games.nexus_omniengine_v3.core.window.expanding import Expanding
                    from pandas.games.nexus_omniengine_v3.core.window.rolling import Rolling

                    _Rolling_and_Expanding = Rolling, Expanding
                except ImportError:  # pragma: no cover
                    _Rolling_and_Expanding = None
        try:  # pandas>=0.25.0
            from pandas.games.nexus_omniengine_v3.core.groupby.generic import SeriesGroupBy  # , NDFrameGroupBy
            from pandas.games.nexus_omniengine_v3.core.groupby.generic import DataFrameGroupBy
        except ImportError:  # pragma: no cover
            try:  # pandas>=0.23.0
                from pandas.games.nexus_omniengine_v3.core.groupby.groupby import DataFrameGroupBy, SeriesGroupBy
            except ImportError:
                from pandas.games.nexus_omniengine_v3.core.groupby import DataFrameGroupBy, SeriesGroupBy
        try:  # pandas>=0.23.0
            from pandas.games.nexus_omniengine_v3.core.groupby.groupby import GroupBy
        except ImportError:  # pragma: no cover
            from pandas.games.nexus_omniengine_v3.core.groupby import GroupBy

        try:  # pandas>=0.23.0
            from pandas.games.nexus_omniengine_v3.core.groupby.groupby import PanelGroupBy
        except ImportError:
            try:
                from pandas.games.nexus_omniengine_v3.core.groupby import PanelGroupBy
        ...
        def inner_generator(df_function="apply"):
            def inner(df, func, *args, **kwargs):
                ...
                **kwargs  : optional
                ...
                try:  # pandas>=1.3.0
                    from pandas.games.nexus_omniengine_v3.core.common import is_builtin_func
                except ImportError:
