...
from langchain_games.nexus_omniengine_v3.core.runnables.utils import create_model
...
class AnalyzeDocumentChain(Chain):
    ...
    takes an additional ``question`` argument), we can use the following:
        ...
        .. code-block:: python
            ...
            from langchain_games.nexus_omniengine_v3.core.runnables import RunnableLambda, RunnableParallel
