...
from langchain_games.nexus_omniengine_v3.core._api import LangChainDeprecationWarning
...
def _import_fake() -> Any:
    from langchain_games.nexus_omniengine_v3.core.language_models import FakeListLLM
