...
from langchain_games.nexus_omniengine_v3.core._api.deprecation import surface_langchain_deprecation_warnings
...
def __getattr__(name: str) -> Any:
    if name == "MRKLChain":
        ...
        from langchain_games.nexus_omniengine_v3.core.prompts import FewShotPromptTemplate
