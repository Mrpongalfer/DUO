...
from langchain_games.nexus_omniengine_v3.core.runnables import RunnableConfig, RunnableSerializable, ensure_config
...
class OpenAIAssistantRunnable(RunnableSerializable[dict, OutputType]):
    ...
    Example using custom tools and custom execution:
        .. code-block:: python
            ...
            from langchain_experimental.openai_assistant import OpenAIAssistantRunnable
            from langchain.agents import AgentExecutor
            from langchain_games.nexus_omniengine_v3.core.agents import AgentFinish
            from langchain.tools import E2BDataAnalysisTool
