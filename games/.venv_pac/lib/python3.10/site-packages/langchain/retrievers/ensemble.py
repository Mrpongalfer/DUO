...
from langchain_games.nexus_omniengine_v3.core.retrievers import BaseRetriever, RetrieverLike
from langchain_games.nexus_omniengine_v3.core.runnables import RunnableConfig
from langchain_games.nexus_omniengine_v3.core.runnables.config import ensure_config, patch_config
...
class EnsembleRetriever(BaseRetriever):
    ...
    def invoke(
        ...
        from langchain_games.nexus_omniengine_v3.core.callbacks import CallbackManager
    ...
    async def ainvoke(
        ...
        from langchain_games.nexus_omniengine_v3.core.callbacks import AsyncCallbackManager
