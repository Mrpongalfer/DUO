...
def main() -> None:
    ...
    parser = ArgumentParser(
        "pbs-install", description="Installer for Python Build Standalone"
    )
    ...
    install_group.add_argument(
        "--version-dir",
        help="Install to a subdirectory named by the version",
        action="store_true",
    )
    install_group.add_argument(
    ...
    install_group.add_argument(
        "--arch", choices=archs, help="Override the architecture to install"
    )
    install_group.add_argument(
    ...
    parser.add_argument(
        "-l", "--list", action=ListAction, help="List installable versions"
    )
