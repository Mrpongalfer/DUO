...
def main_generator(args: argparse.Namespace):
    ...
    import os
    npt_base_dir = os.environ.get("NPT_BASE_DIR", os.getcwd())
    default_scribe_path = str(Path(npt_base_dir) / "scribe_agent.py")
    default_exwork_path = str(Path(npt_base_dir) / "ex_work_agentv2.py")
